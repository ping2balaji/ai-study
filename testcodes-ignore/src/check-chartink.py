...
SCAN_CLAUSE = "( {1394633} ( [0] 15 minute close >= [-1] 15 minute min( 500 , [-1] 15 minute low ) * 1.01 and [0] 15 minute close <= [-1] 15 minute min( 500 , [-1] 15 minute low ) * 1.06 and( {1394633} ( ( {1394633} ( [0] 15 minute rsi( 7 ) > 88 and [ -1 ] 15 minute rsi( 7 ) <= 88 and [0] 15 minute sma( [0] 15 minute volume , 20 ) > [-1] 15 minute sma( [0] 15 minute volume , 20 ) ) ) or( {1394633} ( [-1] 15 minute rsi( 7 ) > 88 and [ -2 ] 15 minute rsi( 7 ) <= 88 and [-1] 15 minute sma( [0] 15 minute volume , 20 ) > [-2] 15 minute sma( [0] 15 minute volume , 20 ) ) ) or( {1394633} ( [-2] 15 minute rsi( 7 ) > 88 and [ -3 ] 15 minute rsi( 7 ) <= 88 and [-2] 15 minute sma( [0] 15 minute volume , 20 ) > [-3] 15 minute sma( [0] 15 minute volume , 20 ) ) ) or( {1394633} ( [-3] 15 minute rsi( 7 ) > 88 and [ -4 ] 15 minute rsi( 7 ) <= 88 and [-3] 15 minute sma( [0] 15 minute volume , 20 ) > [-4] 15 minute sma( [0] 15 minute volume , 20 ) ) ) or( {1394633} ( [-4] 15 minute rsi( 7 ) > 88 and [ -5 ] 15 minute rsi( 7 ) <= 88 and [-4] 15 minute sma( [0] 15 minute volume , 20 ) > [-5] 15 minute sma( [0] 15 minute volume , 20 ) ) ) or( {1394633} ( [-5] 15 minute rsi( 7 ) > 88 and [ -6 ] 15 minute rsi( 7 ) <= 88 and [-5] 15 minute sma( [0] 15 minute volume , 20 ) > [-6] 15 minute sma( [0] 15 minute volume , 20 ) ) ) or( {1394633} ( [-6] 15 minute rsi( 7 ) > 88 and [ -7 ] 15 minute rsi( 7 ) <= 88 and [-6] 15 minute sma( [0] 15 minute volume , 20 ) > [-7] 15 minute sma( [0] 15 minute volume , 20 ) ) ) ) ) ) )"
