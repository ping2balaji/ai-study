...
--------- 
Or single command can be:
python3 testcodes-ignore/src/s1ap-pcap-analysis/pcapanalysis_main.py \
  testcodes-ignore/src/s1ap-pcap-analysis/sample-pcap/stanford-1.pcapng \
  --tshark "C:\Program Files\Wireshark\tshark.exe" \
  --export-start 2025-09-17T00:01:00Z --export-end 2025-09-18T23:59:00Z \
  --failed-flows-only 
